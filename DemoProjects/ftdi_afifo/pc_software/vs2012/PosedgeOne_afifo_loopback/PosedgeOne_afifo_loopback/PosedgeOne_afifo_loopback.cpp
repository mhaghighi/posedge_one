// PosedgeOne_afifo_loopback.cpp : Defines the entry point for the console application.
//
...
// Author      : mahmoud
// Version     :
// Copyright   : copyright Posedge.ir
// Description : posedge-one async-fifo usb loopback
//============================================================================
#include <stdafx.h>
#include <iostream>
using namespace std;
